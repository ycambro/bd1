...
public class WeatherServiceImplTest {
    ...
    public void whenReportByZipCodeAndDataIsStoredLocally_ThenReturnLocalData() {
        ...
        var service = new WeatherServiceImpl(remoteWeatherProvider,
                weatherReportStorage);

        var actual = service.getByZipCode("21201");

        verify(weatherReportStorage, times(1)).find(anyString());
        verify(remoteWeatherProvider, never()).getByZipCode("21201");
